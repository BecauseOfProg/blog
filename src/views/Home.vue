<template>
  <main>
    <b-intro-div 
      title="BecauseOfProg" 
      subtitle="Actualités et tutoriels sur le numérique et la programmation."/>
        ...
        <v-container 
          ...
          <v-layout 
            ...
            <h1><v-icon 
              ...
              color="grey darken-4" 
              size="27" 
              class="pb-1 pt-1">mdi-history</v-icon>&nbsp;Derniers articles</h1>
            <v-flex xs12>
              <v-layout 
                row 
                wrap>
            ...
            <v-flex 
              ...
              <v-btn 
                color="primary" 
                to="/articles">Voir plus<v-icon right>mdi-menu-right</v-icon></v-btn>
            </v-flex>
          </v-layout>
        </v-container>
      </v-layout>
